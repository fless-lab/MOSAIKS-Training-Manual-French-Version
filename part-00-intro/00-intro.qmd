...
In the next chapter, we'll set up our computing environment using Google Colab. This course uses Colab to demonstrate various ascpects of MOSAIKS, in a free and accessible environment.
:::
